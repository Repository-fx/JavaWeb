		...
		$(function () {
			...
			$("#searchPageBtn").click(function () {
				...
				if (pageNo>0 && pageNo<=${requestScope.page.pageTotal}){
					//javaScript中有一个location地址栏对象，它有一个href，可以取到浏览器地址栏中的地址
					//href属性可读可写
					location.href="${pageScope.basePath}${requestScope.page.url}&pageNo="+pageNo;
				}else{
					alert("索引【"+pageNo+"】超出范围");
					return false;
				}
			});
			//给加入购物车按钮绑定单击事件
			$("button.addToCart").click(function () {
				...
				$.getJSON("http://localhost:8080/book/cartServlet","action=ajaxAddItem&bookId="+bookId,function (data) {
					...
					$("#cartLastName").text("您刚刚将"+data.lastName+"添加到购物车中了");
				});
...
<%--					购物车为空的输出--%>
					<span id="cartTotalCount">您的购物车中还没有商品</span>
					<div>
